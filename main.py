...
def register():
    ...
    if request.method == "POST":
        ...
        existing_email = User.query.filter_by(email=get_email).first()
...
def login():
    ...
    return render_template("login.html", form=form, email_error=email_error, password_error=password_error)
